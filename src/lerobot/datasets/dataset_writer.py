...
class DatasetWriter:
    ...
    def add_frame_bytes(self, frame: dict, format: str | dict[str, str] | None = None) -> None:  # noqa: A002
        ...
        Image keys may be compressed bytes or decoded arrays — both are handled per key.
        ...
        Args:
            ...
            format: explicit format override for byte payloads.
                ...
                str → apply this format to every image key (e.g. "jpeg").
                dict → per-key override (e.g. {"cam_left": "jpeg", "cam_right": "webp"}).
        """
        from lerobot.datasets.lerobot_dataset import resolve_image_format
